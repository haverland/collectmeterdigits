...
def main():
    ...
    if (args.labeling==''):
        collect(args.collect, args.days, keepolddata=args.keepdownloads, download=not args.nodownload, startlabel=args.startlabel, savedublicates=args.savedublicates)
    else:
